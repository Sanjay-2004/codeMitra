    ...
    return (
        <div className="flex items-center justify-around bg-stone-950 h-fit">
            <div className="flex flex-col p-8">
                <Link to="/" className="mt-16 mb-8 w-[200px] bg-stone-900 text-slate-200 rounded-lg text-xl h-[60px] font-semibold border border-stone-800 flex items-center justify-center px-4 space-x-2 hover:bg-stone-800">
